    ...
    <div className="flex flex-col justify-center items-center w-full min-h-screen md:w-[55%]">
      ...
      >
        ...
        <div className="grid grid-cols-3 items-center space-x-4">
          <button className="buttonsMain" onClick={handleClick}>
            Get Your Free Cards!
          </button>
          {!clicked ? (
            <button
              className="bg-[#a52a2a] text-lg text-white rounded-lg px-6 py-2"
              onClick={handleSpin}
            >
              Spin!
            </button>
            ...
            <button
              className="bg-[#a52a2a] text-lg text-white rounded-lg opacity-50 px-6 py-2"
              disabled
            >
              Already done!
            </button>
          ...
          <button
            className="border-[#a52a2a] border text-lg text-black hover:bg-[#a52a2a] hover:text-white rounded-lg px-6 py-2"
            onClick={handleSkip}
          >
            Skip
          </button>
