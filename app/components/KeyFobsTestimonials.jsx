            ...
            <div className="carousel-wrapper w-[90%] h-auto ">
                ...
                <div className="flex flex-col justify-center h-[70vh] items-center carousel-item rounded-lg item-1 shadow-lg bg-[#d6d6d665]">
                    ...
                    <div className="flex flex-col justify-between items-center gap-2">
                        <p className='fontTitle' style={{color:'#4a6bb6'}}>Donald Beckett - Scooters</p>
                ...
                <div className="flex flex-col justify-center h-[70vh] items-center carousel-item rounded-lg item-2 shadow-lg bg-[#d6d6d665]">
                    {/* <img className="rounded-lg" style={{height:'5rem' , marginBottom: '10px'}} src="https://res.cloudinary.com/dbhtt5ozr/image/upload/v1687151170/The_Salon_SL_11_-02_p8vdyu.png" alt="" /> */}
                    <div className="flex flex-col justify-between items-center gap-2">
                        <p className='fontTitle' style={{color:'#4a6bb6'}}>Mandy Anderson - J & A Anderson Roofing</p>
                        <p className="fontGeneral">
                            &quot;
                ...
                <div className="flex flex-col justify-center h-[70vh] items-center carousel-item rounded-lg item-4 shadow-lg bg-[#d6d6d665]">
                    ...
                    <div className="flex flex-col justify-between items-center gap-2 mt-2">
                        ...
                        <p className="fontGeneral">
                            &quot;
                            I've used the plastic key fobs as service reminders but they also double up for making sure our customers have our contact details to hand. We have a lot of repeat customers who re-use the key fobs which saves me ordering more, they've lasted years already. Happy with the product and service.
                ...
                <div className="flex flex-col justify-center h-[70vh] items-center carousel-item rounded-lg item-5 shadow-lg bg-[#d6d6d665]">
                    ...
                    <div className="flex flex-col justify-between items-center gap-2">
                        <p className='fontTitle' style={{color:'#4a6bb6'}}>Neil Lack Insurance</p>
                        <p className="fontGeneral">
                            &quot;
                            We have used the guys at Proactiv for our plastic keyfobs since 2016. As an insurance company they are a great way for our customers to have on hand our contact details at a time they most need us, usually in an emergency. They have been an invaluable addition to the service we offer our valued customers & have also helped bring lots of business through word of mouth. Great service and excellent value. Highly recommend.
                            &quot;
                        </p>
                    </div>
